...
// Fetch all cards ordered by newest
       ...
       <header>
              ...
              >
                <li>
                  ...
                  <a href="index.html"class="nav-link text-secondary  "style="background-color: #CBF3BB;">
...
<div class="banner">
  ...
  <div class="banner-text">Хайртай дотны хүмүүстээ <br> Хамгийн амттайг</div>
</div>

<div class="menu">
  <h>Долоо хоногийн зохистой хооллолтын мэню </h1>
  <p>Бидний санал болгож буй өдөр тутмын эрүүл хооллолтын
  мэнюг дагаад хэрэгжүүлээд үзээрэй.</p>
</div>

  </div>
<section class="gap-5">
  
<button class="btn btn-success">Даваа</button>
<button class="btn btn-success">Мягмар</button>
<button class="btn btn-success">Лхагва</button>
<button class="btn btn-success">Пүрэв</button>
<button class="btn btn-success">Баасан</button>
<button class="btn btn-success">Бямбаа</button>
<button class="btn btn-success">Ням</button>
</section>
<div class="container mt-4">
    <h2 class="mb-4 text-center">Шинээр нэмэгдсэн жорууд</h2>

    <div class="row">
        <?php while ($card = $result->fetch_assoc()): ?>
        <div class="col-md-6- col-sm-6 mb-4">
            <div class="card flex h-10 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text mt-2">
                        ...
                        <?php echo nl2br(htmlspecialchars($card['ingredients'])); ?>
                    </p>

                    <!-- Instructions -->
                    <p class="card-text">
                        <strong>Instructions:</strong><br>
                        <?php echo nl2br(htmlspecialchars($card['instructions'])); ?>
                    </p>
                </div>

                <div class="card-footer text-muted small">
                    Added: <?php echo $card['created_at']; ?>
                </div>
            </div>
        </div>
        <?php endwhile; ?>
...
<div class="youtube"><iframe width="560" height="315" src="https://www.youtube.com/embed/JNAZI7n1VNU?si=glNcr6CGVAscsmoJ"
