...
<body>
  <header>
    <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
        ...
        <a href="index.html" class="nav-link text-black">
          <svg class="bi d-block mx-auto mb-1" width="32px" height="32px" viewBox="0 0 24 24" fill="#66ff00"
            ...
            <g id="SVGRepo_iconCarrier">
              <path d="M22 22L2 22" stroke="#00bd03" stroke-width="1.5" stroke-linecap="round"></path>
              <path
                d="M2 11L6.06296 7.74968M22 11L13.8741 4.49931C12.7784 3.62279 11.2216 3.62279 10.1259 4.49931L9.34398 5.12486"
                stroke="#00bd03" stroke-width="1.5" stroke-linecap="round"></path>
              <path d="M15.5 5.5V3.5C15.5 3.22386 15.7239 3 16 3H18.5C18.7761 3 19 3.22386 19 3.5V8.5" stroke="#00bd03"
                stroke-width="1.5" stroke-linecap="round"></path>
              <path d="M4 22V9.5" stroke="#00bd03" stroke-width="1.5" stroke-linecap="round"></path>
              <path d="M20 9.5V13.5M20 22V17.5" stroke="#00bd03" stroke-width="1.5" stroke-linecap="round"></path>
              <path
                d="M15 22V17C15 15.5858 15 14.8787 14.5607 14.4393C14.1213 14 13.4142 14 12 14C10.5858 14 9.87868 14 9.43934 14.4393M9 22V17"
                stroke="#00bd03" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
              <path
                d="M14 9.5C14 10.6046 13.1046 11.5 12 11.5C10.8954 11.5 10 10.6046 10 9.5C10 8.39543 10.8954 7.5 12 7.5C13.1046 7.5 14 8.39543 14 9.5Z"
                stroke="#00bd03" stroke-width="1.5"></path>
            </g>
          </svg>
          Нүүр хуудас
      ...
      <li><a href="bread.html" class="nav-link text-black">
          <svg class="bi d-block mx-auto mb-1" width="32px" height="32px" viewBox="0 0 24 24" fill="#66ff00"
            xmlns="http://www.w3.org/2000/svg">
            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
      ...
      <li>
        <form class="  mx-5 my-3 mb-1" role="search">
          <input type="search" class="mx-5 form-control" placeholder="Хайх..." aria-label="Search" />
        </form>
      </li>
      <li>
  ...
  <div class="d-flex justify-content-center">
    ...
    <div class="card mx-4" style="width: 18rem;">
      <img src="Avocada.jpg" class="card-img-top" alt="Авокадотой талх">
      <div class="card-body">
        <h5 class="card-title text-center">Авокадотой талх</h5>
        <p class="d-inline-flex gap-1 w-100 justify-content-center">
          <a class="btn btn-success" data-bs-toggle="collapse" href="#collapseExample19" role="button"
            aria-expanded="false" aria-controls="collapseExample19">
            Орц
          </a>
          <button class="btn btn-light" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample20"
        ...
        <div class="collapse" id="collapseExample19">
          <div class="card card-body">
            <ul>
              <li>Талх – 2 зүсэм</li>
              <li>Авокадо – 1 ширхэг</li>
              <li>Өндөг – 1 ширхэг</li>
              <li>Давс, хар перец – бага зэрэг</li>
            </ul>
          </div>
        </div>
        ...
        <div class="collapse" id="collapseExample20">
          <div class="card card-body">
            ...
            Өндөгөө шараад тавьж хагас шарвал илүү гоё болно. Давс перецээр амтална.
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- suutei oviys -->
    <div class="card mx-4" style="width: 18rem;">
      <img src="cropped-Сүүтэй-овъёос.png" class="card-img-top" alt="Сүүтэй овьёос">
      <div class="card-body">
        <h5 class="card-title text-center">Сүүтэй овьёос</h5>
        <p class="d-inline-flex gap-1 w-100 justify-content-center">
          <a class="btn btn-success" data-bs-toggle="collapse" href="#collapseExample21" role="button"
            aria-expanded="false" aria-controls="collapseExample21">
            Орц
          </a>
          <button class="btn btn-light" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample22"
        ...
        <div class="collapse" id="collapseExample22">
          <div class="card card-body">
            Буцалж буй усанд овьёосны нэвсийг хийгээд зөөлөн гал дээр 20-25 минут чанавал зөөлөн амттай бүрэн болдог.
            Чанах явцад овьёос өсөж өтгөн болдог учир усаа ахиухан хийгээрэй.
            Болсон овьёос дээрээ сүү, шар тос, давс хийж амтлаад 1-2 минут буцалгаж болгоно.
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- jimstei agshaamal -->
    <div class="card mx-4" style="width: 18rem;">
      <img src="Хөвсгөр ТАЛХ.jpg" class="card-img-top" alt="Жимстэй-овъёосны-өтгөн-агшаамал">
      <div class="card-body">
        <h5 class="card-title text-center">Жимстэй овъёосны өтгөн агшаамал</h5>
        <p class="d-inline-flex gap-1 w-100 justify-content-center">
          <a class="btn btn-success" data-bs-toggle="collapse" href="#collapseExample23" role="button"
            aria-expanded="false" aria-controls="collapseExample23">
            Орц
          </a>
          <button class="btn btn-light" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample24"
        ...
        <div class="collapse" id="collapseExample23">
          <div class="card card-body">
            <ul>
              <li>100 г Овьёос</li>
              <li>100 г Сүү</li>
              <li>1 Чимх Синнамон </li>
              <li>1 Чимх Ванила </li>
              <li>1 Чимх Давс</li>
              <li>1 200 г Ус </li>
            </ul>
            <strong>Нэмэлт орц:</strong>
            <ul>
              <li>Дурын хатаасан жимс</li>
              <li>5 ш Холимог самар</li>
              <li>3 г Наранцэцэгийн үр </li>
              <li>1\2 ц\х Зөгийн бал </li>
              <li>1\2 ц\х Самрын нухаш</li>
            </ul>
          </div>
        </div>
        ...
        <div class="collapse" id="collapseExample24">
          <div class="card card-body">
            Овъёосоо холигч машинд хийгээд үйрүүлэх эсвэл чанаж болгоно. \Өөрийн сонголтоор\ Хэрэв чанах бол 5-10
            минутаас хэтрэхгүй.
            200 мл усан дээрээ овъёосоо хийж синнамон, ванила, сүүгээ хийгээд 5-10 минут зөөлөн галаар буцалгана.
            Буцалгахдаа сайтар хутгана.
            Бэлэн болсон овъёосны агшаамал дээрээ нэмэлт орц буюу дурын хатаасан жимс, холимог самар, зөгийн бал,
            наранцэцэгийн үр, самрын нухшаа хийнэ. Ингээд овъёосны агшаамал маань бэлэн боллоо.
          </div>
        </div>
      </div>
    </div>
