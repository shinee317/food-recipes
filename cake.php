...
Оройн хоол
                ...
                <li>
                  <a href="cake.php" class="nav-link text-secondary  "style="background-color: #CBF3BB;">
...
<div class="d-flex justify-content-center">
  ...
  <div class="card mx-4" style="width: 18rem;">
    <img src="cropped-shokolottoi cake.jpg" class="card-img-top" alt="шокалттай бялуу">
    <div class="card-body">
      <h5 class="card-title text-center">Шоколадтай бялуу</h5>
      <p class="d-inline-flex gap-1 w-100 justify-content-center">
        <a class="btn btn-success" data-bs-toggle="collapse" href="#collapseExample31" role="button" aria-expanded="false" aria-controls="collapseExample31">
          Орц
        </a>
        <button class="btn btn-light" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample32" aria-expanded="false" aria-controls="collapseExample32">
          Хийх арга
        </button>
      </p>
      ...
      <div class="collapse" id="collapseExample31">
        <div class="card card-body">
          <ul>
            <li>Гурил – 2 аяга</li>
            <li>Какао – 1/2 аяга</li>
            <li>Өндөг – 2 ширхэг</li>
            <li>Элсэн чихэр – 1 аяга</li>
            <li>Сүү – 1 аяга</li>
            <li>Цөцгийн тос – 100 гр</li>
          </ul>
        </div>
      </div>
      ...
      <div class="collapse" id="collapseExample32">
        <div class="card card-body">
        Бүх орцыг хольж зуурмаг бэлдээд шарах шүүгээнд 180°C дээр 30 минут жигнэнэ.
        </div>
      </div>
    </div>
  </div>

  <!-- huren manjin samartai keik -->
   <div class="card mx-4" style="width: 18rem;">
    <img src="Хүрэн-манжинтай-самартай-кейк-1 (1).jpg" class="card-img-top" alt="Хүрэн-манжинтай-самартай-кейк">
    <div class="card-body">
      <h5 class="card-title text-center">Хүрэн манжинтай самартай кейк</h5>
      <p class="d-inline-flex gap-1 w-100 justify-content-center">
        <a class="btn btn-success" data-bs-toggle="collapse" href="#collapseExample33" role="button" aria-expanded="false" aria-controls="collapseExample33">
          Орц
        </a>
        <button class="btn btn-light" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample33" aria-expanded="false" aria-controls="collapseExample34">
          Хийх арга
        </button>
      </p>
      ...
      <div class="collapse" id="collapseExample33">
        <div class="card card-body">
         <ul>
            ...
            <li>Аарц</li>
            <li>Нухсан самар</li>
            <li>20 г Элсэн чихэр</li>
            <li>1 ц\х Хөөлгөгч</li>
            <li>1 ц\х Давс</li>
            <li>2 ц\х Ургамалын тос</li>
            <li>Хуурай гурил</li>
            <li>Ванила</li>
          </ul>
        </div>
      ...
      <div class="collapse" id="collapseExample34">
        <div class="card card-body">
       Хүрэн манжин, аарцаа цахилгаан холигчинд хийн блиндердэнэ.Хуурай гурилан дээрээ давс, элсэн чихэр, хөөлгөгч, ургамалын тос, ванила нэмэн хүрэн манжингийн бэлдэцтэйгээ холин зөөлөн хутгана.
Үүний дараа хэвэндээ бэлдэцээ 1\2 хэмжээтэй байхаар хийн дээрээс нь нухсан самараа тавин цахилгаан зуухаа 180С градусын хэмд 30 минут жигнэж болгоно.
      </div>
    </div>
        </div>
      </div>
    <!-- Сэвэг-зарамтай-панкейк-->
    <div class="card mx-4" style="width: 18rem;">
    <img src="cropped-Сэвэг-зарамтай-панкейк.jpg" class="card-img-top" alt="Сэвэг-зарамтай-панкейк">
    <div class="card-body">
      <h5 class="card-title text-center">Сэвэг зарамтай панкейк</h5>
      <p class="d-inline-flex gap-1 w-100 justify-content-center">
        <a class="btn btn-success" data-bs-toggle="collapse" href="#collapseExample35" role="button" aria-expanded="false" aria-controls="collapseExample35">
          Орц
        </a>
        <button class="btn btn-light" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample36" aria-expanded="false" aria-controls="collapseExample36">
          Хийх арга
        </button>
      </p>
      ...
      <div class="collapse" id="collapseExample35">
        <div class="card card-body">
           <ul>
            <li>300 гр Сэвэг зарам</li>
            <li>40 мл Сүү</li>
            <li>20 г Яншуй</li>
            <li>2ш өндөг</li>
            <li>Наранцэцэгийн тос</li>
            <li>Давс</li>
          </ul>
        </div>
      </div>
      ...
      <div class="collapse" id="collapseExample36">
        <div class="card card-body">
          Сэвэг зарамаа урьдчилан 2 цаг халуун усанд дэвтээж бэлдсэн байна.
Дэвтээсэн сэвэг зарамаа хүйтэн усаар сойгоод цахилгаан блиндерт бүх орцуудаа хийгээд нэгэн жигд бүтэцтэй болтол блиндердэнэ.
Хайруулын тавагтаа тосоо хийн халааж блиндердсэн орцуудаа дунд зэргийн галаар шарж болгоно.
Ингээд таны уураг эслэгээр баялаг шинэхэн панкек маань бэлэн боллоо.
        </div>
      </div>
    </div>
  </div>
